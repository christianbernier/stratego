...
public class Sorceress extends AbstractMovablePiece {
  public Sorceress(PlayerTheme owner) throws IllegalArgumentException {
    super(GamePieceType.SORCERESS, owner);
  }
  ...
  protected String executeSpecialMove(GamePiece[][] board, Move move) throws IllegalArgumentException {
    ...
    if (piece.getType().getStrength() < this.getType().getStrength()) {
      piece.changeSides();
    }

    return "Enchant! Revealed: " + pieceName;
  }
}
